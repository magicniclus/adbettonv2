...
export const metadata: Metadata = {
  title: "Adbetton Maçonnerie - Excellence familiale depuis 2 générations Saint-Malo | Devis Gratuit",
  ...
  openGraph: {
    title: "Adbetton Maçonnerie - Excellence familiale depuis 2 générations Saint-Malo",
    ...
    type: "website",
    locale: "fr_FR",
    siteName: "Adbetton Maçonnerie - Excellence familiale depuis 2 générations",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Adbetton Maçonnerie - Excellence familiale depuis 2 générations Saint-Malo",
      },
    ],
  },
  twitter: {
